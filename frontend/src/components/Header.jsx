...
// Если используешь lucide-react или другую иконку — подключи тут
    ...
    <header className="fixed top-0 left-0 w-full z-50 bg-rose-50/95 backdrop-blur-sm shadow-sm border-b border-rose-100">
      <div className="max-w-6xl mx-auto px-4 md:px-6 lg:px-8 py-3 md:py-4 flex items-center gap-3 md:gap-6">
        ...
        <nav className="hidden md:flex items-center gap-5 text-sm font-medium text-rose-700 ml-4">
          ...
          <a href="/tips" className="hover:text-rose-500 transition-colors">
            Советы
          </a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          {/* Заглушка для будущего аккаунта/иконки */}
          {/* <button className="hidden md:inline-flex text-rose-500 hover:text-rose-700 text-sm">
            Войти
          </button> */}
          ...
          <button
            ...
            aria-label="Корзина"
          >
            {/* Если нет библиотеки иконок — простой SVG */}
            <svg
