        ...
        {cart.length > 0 && !isSuccess && (
          <div className="p-5 border-t border-stone-100 bg-white rounded-b-2xl">
            ...
            <form onSubmit={handleSubmit} className="space-y-3">
              ...
              <input value={formData.address} onChange={e => setFormData({...formData, address: e.target.value})} type="text" placeholder="Адрес доставки" className="w-full border border-stone-200 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-emerald-500 outline-none" />
