...
export const Filters: React.FC<FiltersProps> = ({
  ...
  // Получаем уникальные значения из props? Нет, мы их не передаём. Поэтому используем заранее известные списки.
  ...
  const handleEnvironmentChange = (env: 'ground' | 'greenhouse') => {
    // Если уже выбран этот же – сбрасываем, иначе устанавливаем
    ...
    <div className="space-y-6 bg-white p-5 rounded-xl shadow-sm border border-stone-200">
      ...
      <div>
        <div className="flex items-center justify-between mb-2">
          ...
          <span className="text-xs text-stone-400 cursor-help" title="Для грядок рекомендуются низкорослые и ранние сорта. В теплице можно выращивать любые.">
            ⓘ
          </span>
        </div>
