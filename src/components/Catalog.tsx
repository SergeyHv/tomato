  ...
  return (
    <>
      ...
      <div className="space-y-6">
       ...
       <div className="sticky top-20 z-30 bg-white pt-2 pb-2 lg:hidden shadow-sm"> Раскройте блок фильтров(три полоски) или впишите в строку поиска слово(или часть), например, сладк или пальчик
